  ...
  return (
    <section className="container mx-auto px-4 md:px-0">
      ...
      <div className="mb-5 grid grid-cols-3 items-center gap-4 font-bold md:grid-cols-[1fr_3fr] md:gap-0">
        ...
        <span className="mr-auto rounded-xl bg-pale-orange py-1 px-2 text-orange-primary md:text-left">
      ...
      <div className="mx-auto grid grid-cols-3 items-center gap-4 font-bold md:grid-cols-[1fr_1.8fr]">
        <div className="col-span-3 flex items-baseline justify-between rounded-xl bg-gray-200 py-1 px-5 pb-3 md:col-span-1">
          <button
        ...
        <button
          ...
          className="col-span-3 flex items-center justify-center gap-3 rounded-xl bg-orange-primary py-3 text-white transition-all hover:bg-orange-700 md:col-span-1"
        >
